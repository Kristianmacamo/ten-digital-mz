...
const streamingPlans = {
    ...
    deezer: [
        { name: 'Individual', price: 420 },
        { name: 'Família', price: 650 }
    ],
    hbomax: [
